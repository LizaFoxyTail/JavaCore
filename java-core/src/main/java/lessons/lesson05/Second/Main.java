...
public class Main {
    public static void main(String[] args) {
        ...
        quiz1.AddQuestion(new TrueFalseQuestion("The Earth is flat? ", false));
        ...
        quiz1.AddQuestion(new TrueFalseQuestion("Basketball was invented in the USA.", true));
        quiz1.AddQuestion(new OpenQuestion("What is 12 multiplied by 8?", "96"));
        quiz1.AddQuestion(new TrueFalseQuestion("Albert Einstein developed the theory of relativity.", true));
